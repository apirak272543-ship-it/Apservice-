...
- [ ] ออกแบบระบบ Recognition สำหรับร้านค้าและไรเดอร์ที่สรุป Tier ผลงานรายสัปดาห์/รายเดือน และสถิติการติดระดับต่อเนื่องจากข้อมูลจริง
- [ ] กำหนดแนวทางแจ้งความสำเร็จอัตโนมัติที่บันทึกได้เฉพาะเหตุการณ์ใหม่ ลดการแจ้งซ้ำ และรองรับหน้าต่างคอนเฟตตีตามบทบาท
- [ ] กำหนดข้อมูล Recognition ที่หน้าโปรไฟล์ของร้านค้าและไรเดอร์จะแสดง เช่น Tier ปัจจุบัน อันดับพิเศษ ลำดับติดระดับต่อเนื่อง คะแนนรีวิว และผลการทำงานที่มีสิทธิ์เห็น
- [ ] เพิ่มป้ายผู้ใช้งานคุณภาพสูงแบบอันดับ Top 50 สำหรับผู้ที่ไม่ติด Tier 1–3 โดยคำนวณจากข้อมูลจริงและไม่เปิดเผยข้อมูลส่วนบุคคลที่ไม่จำเป็น
