(() => {
  ...
  root.APServiceMPA = Object.freeze({ version: 'mpa-runtime-v2', config: { url: SUPABASE_URL, publishableKey: SUPABASE_KEY }, request: lifecycle.request, network: lifecycle, auth: { getSession, refreshSession, signIn, signOut, currentUser, rolesFor, requireRole }, ui: { escapeHtml, baht, nowIso, loading, error, empty, setNotice }, cart });
})();
