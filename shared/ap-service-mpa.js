(() => {
  ...
  root.APServiceMPA = Object.freeze({ version: 'mpa-runtime-v4', config: { url: SUPABASE_URL, publishableKey: SUPABASE_KEY }, request: lifecycle.request, requestCount: lifecycle.requestCount, network: lifecycle, auth: { getSession, refreshSession, signIn, signUp, sendMagicLink, sendPasswordRecovery, acceptMagicLinkFromHash, acceptRecoveryFromHash, updatePassword, signOut, confirmSignOut, currentUser, rolesFor, customerRolesFor, requireRole }, ui: { escapeHtml, baht, nowIso, loading, error, empty, setNotice }, cart });
