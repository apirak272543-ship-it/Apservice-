(() => {
  ...
  const fallbackCards = [
    { id: 'food', enabled: true, sortOrder: 10, icon: '🍜', title: 'สั่งอาหาร', description: 'เลือกจากร้านเด็ดใกล้คุณ พร้อมเมนูยอดนิยม', href: 'stores.html', actionLabel: 'เปิดบริการ', altText: 'สั่งอาหาร', textColor: '#102a2a', backgroundColor: '#ffffff' },
    { id: 'supermarket', enabled: true, sortOrder: 20, icon: '🛒', title: 'ซูเปอร์มาร์เก็ต', description: 'เลือกซื้อจากร้านใกล้คุณในหน้าเดียว', href: 'stores.html?category=supermarket', actionLabel: 'เลือกซื้อสินค้า', altText: 'ซูเปอร์มาร์เก็ต', textColor: '#102a2a', backgroundColor: '#ffffff' },
