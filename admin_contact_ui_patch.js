(() => {
  ...
  detailStyle.textContent = `
    .store-detail-modal .modal{max-width:760px;padding:0;overflow:hidden}.store-detail-head{padding:18px 18px 14px;background:linear-gradient(135deg,#075c52,#129b87);color:#fff}.store-detail-head h2{margin:0;font-size:20px}.store-detail-head p{margin:5px 0 0;color:rgba(255,255,255,.82);font-size:11px}.store-detail-head .modal-close{color:#fff;background:rgba(255,255,255,.14);border:0}.store-detail-tabs{display:flex;gap:6px;overflow:auto;padding:10px 12px;background:#f4fbf9;border-bottom:1px solid #dceeea;scrollbar-width:none}.store-detail-tabs button{white-space:nowrap;min-height:34px;border:1px solid #cde5df;border-radius:999px;background:#fff;color:#175a51;font-size:11px;font-weight:850;padding:6px 10px}.store-detail-tabs button.active{background:#087d68;color:#fff;border-color:#087d68}.store-detail-body{padding:16px;max-height:65vh;overflow:auto}.store-reference-card{padding:12px;border:1px dashed #bbd9d3;border-radius:13px;background:#f7fcfa;margin-bottom:13px}.store-reference-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.store-reference-grid span{display:block;font-size:10px;color:var(--muted)}.store-reference-grid b{display:block;overflow-wrap:anywhere;color:var(--ink);font-size:12px;margin-top:2px}.store-detail-section-title{margin:0 0 4px;font-size:16px}.store-detail-section-note{margin:0 0 14px;color:var(--muted);font-size:11px;line-height:1.5}.store-detail-form{display:grid;gap:11px}.store-detail-form .form-grid{margin:0}.store-detail-action-row{display:flex;justify-content:flex-end;gap:8px;flex-wrap:wrap;padding-top:5px}.store-detail-empty{padding:18px;text-align:center;color:var(--muted)}.store-detail-moderation{display:grid;gap:10px}.store-detail-moderation .btn{justify-content:center}.store-detail-warning{padding:11px;border-radius:12px;background:#fff5df;color:#8b5a03;font-size:11px;line-height:1.5}@media(max-width:640px){.store-detail-modal .modal{width:min(96vw,760px)}.store-detail-body{padding:13px;max-height:72vh}.store-reference-grid{grid-template-columns:1fr}.store-detail-tabs{padding:9px}.store-detail-tabs button{font-size:10px;padding:6px 9px}}
  `;
  ...
  window.renderStoreDetail = (id, preferredTab) => {
    ...
    q('#storeDetailHead').innerHTML = `<div class="store-detail-head"><button type="button" class="modal-close" onclick="closeModal('storeDetailModal')">×</button><h2>${esc(store.name)}</h2><p>หน้ารายละเอียดร้าน · แก้ไขเป็นรายหมวด</p></div>`;
