...
assert.match(app, /M\.auth\.signInWithOAuth\(provider, callback\.href/);
assert.match(app, /กำลังเชื่อมต่อ \$\{provider\}/);
...
assert.match(profile, /customer-auth-v8-social-providers/);
