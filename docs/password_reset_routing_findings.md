...
หลัง deploy commit `010a33a` หน้า `https://apirak272543-ship-it.github.io/Apservice-/customer/recover.html` โหลดได้จริง และเมื่อจำลองการ submit โดยดักคำขอไว้ใน browser ไม่เรียก Supabase จริง ค่าที่ส่งเข้า `sendPasswordRecovery` คือ `https://apirak272543-ship-it.github.io/Apservice-/customer/update-password.html` ซึ่งมี repository base path ถูกต้อง.

หน้า `https://apirak272543-ship-it.github.io/Apservice-/customer/update-password.html` ตอบ HTTP 200 และแสดงฟอร์มตั้งรหัสผ่านใหม่. การทดสอบนี้ยังไม่ได้ใช้ recovery token จริงและไม่ได้เปลี่ยนรหัสผ่านของบัญชีใด.
